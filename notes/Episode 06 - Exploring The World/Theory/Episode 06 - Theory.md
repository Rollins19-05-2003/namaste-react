...
- whatever is written inside a useEffect() hook is called after the UI is render i.e.,
    useEffect(()=>{
        console.log("useEffect called");
    }, []);

    useEffect called is printed in console after the complete body is rendered.
